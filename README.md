# Manifest for building LineageOS 19.1 for gtaxlwifi and gtanotexlwifi
...
```
git clone https://github.com/TALUAtGitHub/gtaxlwifi-manifests.git -b lineage-19.1 .repo/local_manifests
```
